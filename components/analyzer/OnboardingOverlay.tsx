...
const STEPS: Step[] = [
  {
    title: 'Welcome to DoneWell Audio',
    description:
      'DoneWell Audio detects acoustic feedback in real time and tells you exactly where to cut. Walk through these 5 steps to get started.',
  ...
  return (
    ...
    >
      <div className="bg-card/90 border border-border/40 rounded max-w-md w-full p-6 shadow-xl backdrop-blur-sm animate-in fade-in zoom-in-95 duration-200">
        {/* Icon */}
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-[rgba(var(--tint-r),var(--tint-g),var(--tint-b),0.10)] border border-[rgba(var(--tint-r),var(--tint-g),var(--tint-b),0.20)] mb-4 mx-auto">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          {step === 0 ? (
            <button
              onClick={dismiss}
              className="text-sm font-mono tracking-wide text-muted-foreground hover:text-foreground transition-colors px-3 py-2 rounded hover:bg-card/40 cursor-pointer outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
            >
              Skip
            </button>
          ) : (
            <button
              onClick={back}
              className="inline-flex items-center gap-1 text-sm font-mono tracking-wide text-muted-foreground hover:text-foreground transition-colors px-3 py-2 rounded hover:bg-card/40 cursor-pointer outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
            >
          ...
          <button
            onClick={next}
            className="inline-flex items-center gap-1 text-sm font-mono font-bold tracking-wide bg-primary text-primary-foreground px-4 py-2 rounded hover:bg-primary/90 transition-colors cursor-pointer outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50"
          >
